...
HARDCODED_ADMIN_IDS = [7323192068, 6028572049, 5646492454, 6224953439, 5733576801, -1002798580895]

# Restricted user IDs - these users' proxy info cannot be viewed/modified even by admins
RESTRICTED_USER_IDS = [7323192068, 6307224822]
    ...
    try:
        ...
        if not allowed:
            await update.message.reply_text(
                "Access restricted.\n\n"
                "Join Group To Check: https://t.me/+tV0ytZlyNgY5YWU1\n\n"
                "Owner: @Tyrant_Xd"
            )
            return False
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
        "👨‍💻 <b>Developer:</b> @Tyrant_Xd\n"
        "📢 <b>Join our GC:</b> https://t.me/+tV0ytZlyNgY5YWU1",
        parse_mode=ParseMode.HTML
    )
